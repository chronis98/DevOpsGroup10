<template>
	...
	<div v-for="l in locations">
		...
		<CardComponent source="https://img.freepik.com/premium-vector/barbell-dumbbell-gym-icon-logo-template-gym-badge-fitness-logo-design_757387-345.jpg?w=2000" name='' :date="l.date" v-on:click.native="handleClick(l.name)">
